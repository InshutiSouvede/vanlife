...
export default function Login() {
  ...
  return (
    <div className="p-10">
      ...
      {loginWarning && (
        <p className="text-red-800 text-xl font-semibold text-center">
          {loginWarning}
        </p>
      )}
      {erroMessage && (
      ...
      <Form method="post" className="flex flex-col my-10" replace>
        <input
          name="email"
          className=" rounded-br-none rounded-bl-none rounded-md h-10 border border-gray-400 px-5 "
          type="text"
          placeholder="Email address"
        />
        <input
          name="passwd"
          className="rounded-tr-none rounded-tl-none rounded-md h-10 border border-gray-400 px-5 "
          type="password"
          placeholder="Password"
        />
        <button
          type="submit"
          className="bg-[#FF8C38] text-white font-bold  h-10 rounded-md my-10"
        >
          Sign in
        </button>
      </Form>
